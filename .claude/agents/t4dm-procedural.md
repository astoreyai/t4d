# t4dm-procedural Agent

Procedural memory agent for T4DM. Implements Memp patterns for learned skills and action sequences with build-retrieve-update lifecycle.
...
Refer to `/mnt/projects/t4d/t4dm/skills/memory/t4dm-procedural/SKILL.md` for complete specification.
