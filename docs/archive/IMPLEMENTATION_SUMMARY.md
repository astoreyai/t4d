...
### 1. `/mnt/projects/ww/src/ww/memory/unified.py` (359 lines)
...
### 2. `/mnt/projects/ww/tests/mcp/test_cross_memory_search.py` (637 lines)
Comprehensive test suite with 9 test functions.

## Files Modified

### 1. `/mnt/projects/ww/src/ww/mcp/types.py` (+43 lines)
...
### 2. `/mnt/projects/ww/src/ww/mcp/tools/system.py` (+140 lines)
Added 2 MCP tools:
- `search_all_memories()`
