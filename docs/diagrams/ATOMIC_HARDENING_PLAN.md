...
## FOUNDATION-1: `src/t4dm/core/validation.py`
...
## FOUNDATION-2: `src/t4dm/core/provenance.py`
...
## FOUNDATION-3: `src/t4dm/core/access_control.py`
...
- **File**: `src/t4dm/persistence/checkpoint.py`
...
- **Files**: `src/t4dm/nca/hippocampus.py`
...
- **File**: `src/t4dm/nca/dopamine_integration.py`
...
- **Files**: `src/t4dm/consolidation/sleep.py`, `service.py`, `fes_consolidator.py`
...
- **Files**: `src/t4dm/learning/stdp.py`, `src/t4dm/consolidation/stdp_integration.py`
...
- **File**: `src/t4dm/persistence/wal.py`
...
- **Files**: `src/t4dm/persistence/checkpoint.py`, `wal.py`
...
- **File**: `src/t4dm/api/routes/episodes.py`
...
- **Files**: `docs/diagrams/33_state_neuromod.mmd`, `src/t4dm/nca/vta.py:70`
...
- **File**: `src/t4dm/nca/hippocampus.py:1150-1159`
...
- **File**: `src/t4dm/consolidation/sleep.py:1751`
...
- **File**: `src/t4dm/nca/hippocampus.py:723-726`
...
- **Files**: `src/t4dm/nca/swr_coupling.py`, `src/t4dm/nca/sleep_spindles.py`
...
- **File**: New `src/t4dm/nca/invariants.py`
...
- **Files**: `src/t4dm/hooks/memory.py`, `src/t4dm/api/routes/episodes.py`
...
- **Files**: `src/t4dm/nca/vta.py`, `src/t4dm/nca/dopamine_integration.py`
...
- **File**: `src/t4dm/nca/nucleus_basalis.py`
...
- **File**: `src/t4dm/nca/neuromod_crosstalk.py:47`
...
- **Files**: `src/t4dm/nca/coupling.py`, `src/t4dm/learning/stdp.py`, `src/t4dm/nca/forward_forward.py`, `src/t4dm/nca/capsules.py`
...
- **Files**: `src/t4dm/nca/neural_ode_capsules.py`, `src/t4dm/nca/coupling.py`, `src/t4dm/nca/swr_coupling.py`, `src/t4dm/consolidation/sleep.py`
...
- **File**: `src/t4dm/api/server.py:279`
...
- **Files**: `src/t4dm/nca/forward_forward.py`, `capsules.py`, `coupling.py`
...
- **File**: `src/t4dm/nca/hippocampus.py:236-248`
...
- **Files**: `src/t4dm/consolidation/sleep.py`, `src/t4dm/nca/swr_coupling.py`
...
- **File**: `src/t4dm/learning/stdp.py`, `src/t4dm/consolidation/stdp_integration.py`
...
- **File**: `src/t4dm/nca/theta_gamma_integration.py`
...
- **File**: `src/t4dm/nca/hippocampus.py:429-432`
...
- **File**: `src/t4dm/nca/hippocampus.py:379`
...
- **File**: `src/t4dm/nca/hippocampus.py:392`
...
- **File**: `src/t4dm/nca/hippocampus.py:230-232`
...
- **File**: `src/t4dm/nca/hippocampus.py:250-304`
...
- **File**: `src/t4dm/nca/hippocampus.py:596-601`
...
- **File**: `src/t4dm/nca/hippocampus.py:485-511`
...
- **File**: `src/t4dm/nca/locus_coeruleus.py:875`
...
- **File**: `src/t4dm/nca/nucleus_basalis.py:344-376`
...
- **File**: `src/t4dm/nca/substantia_nigra.py:331`
...
- **File**: `src/t4dm/nca/neuromod_crosstalk.py:46`
...
- **File**: `src/t4dm/consolidation/fes_consolidator.py:28-76`
...
- **File**: `src/t4dm/persistence/checkpoint.py:120`
...
- **File**: `src/t4dm/nca/coupling.py:432`
...
- **File**: `src/t4dm/api/routes/episodes.py:391-437`
...
- **File**: `src/t4dm/storage/saga.py:20-52`
...
- **File**: `src/t4dm/nca/glymphatic_consolidation_bridge.py:502`
...
- **File**: `src/t4dm/api/routes/episodes.py:483-532`
...
- **File**: `src/t4dm/nca/spatial_cells.py`
...
- **File**: `src/t4dm/nca/stability.py`
...
- **File**: `src/t4dm/nca/wm_gating.py`
...
- **File**: `src/t4dm/nca/unified_attention.py`
...
- **File**: `src/t4dm/nca/capsules.py:586-596`
...
- **File**: `src/t4dm/nca/hippocampus.py:476`
...
- **File**: `src/t4dm/nca/forward_forward.py:399`
...
- **File**: `src/t4dm/nca/forward_forward_nca_coupling.py`
...
- **File**: `src/t4dm/nca/theta_gamma_integration.py:157`
...
- **File**: `src/t4dm/nca/locus_coeruleus.py:724`
...
- **File**: `src/t4dm/nca/locus_coeruleus.py:809-815`
