...
if TYPE_CHECKING:
    ...
    from t4dm.nca.attractors import CognitiveState, StateTransitionManager
...
@dataclass
class NCABridgeConfig:
    """Configuration for NCA bridge (renamed from BridgeConfig)."""
...
class NCABridge:
    ...
    def __init__(
        self,
        config: NCABridgeConfig | None = None,
        ...
        """
        self.config = config or NCABridgeConfig()
        ...
        logger.info("NCABridge initialized")
