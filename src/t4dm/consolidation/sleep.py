...
from t4dm.learning.generative_replay import GenerativeReplayConfig, GenerativeReplaySystem
from t4dm.learning.vae_generator import VAEConfig, VAEGenerator
from t4dm.learning.vae_training import VAEReplayTrainer, VAETrainingConfig
...
class SleepConsolidation:
    ...
    def set_plasticity_manager(self, plasticity_manager: Any) -> None:
        ...
        Args:
            plasticity_manager: PlasticityManager instance from t4dm.learning.plasticity
        """
    ...
    def set_generative_replay(self, replay: GenerativeReplaySystem | Any) -> None:
        ...
        Args:
            replay: GenerativeReplaySystem instance from t4dm.learning.generative_replay
        """
    ...
    def set_glymphatic_bridge(self, bridge: Any) -> None:
        ...
        Args:
            bridge: GlymphaticConsolidationBridge from t4dm.nca.glymphatic_consolidation_bridge
        """
    ...
    def set_swr_coupling(self, coupling: Any) -> None:
        ...
        Args:
            coupling: SWRNeuralFieldCoupling from t4dm.nca.swr_coupling
        """
    ...
    def set_dream_consolidation(self, dream_consolidation: Any) -> None:
        ...
        Args:
            dream_consolidation: DreamConsolidation from t4dm.dreaming.consolidation
        """
    ...
    def set_vta_circuit(self, vta_circuit: Any) -> None:
        ...
        Args:
            vta_circuit: VTACircuit from t4dm.nca.vta
        """
    ...
    def set_reconsolidation_engine(self, engine: Any) -> None:
        ...
        Args:
            engine: ReconsolidationEngine instance from t4dm.learning.reconsolidation
        """
                ...
                for pos, episode in enumerate(ripple_seq):
                    ...
                    if self._swr_coupling is not None:
                        try:
                            ...
                            from t4dm.nca.swr_coupling import SWRPhase
    ...
    async def _create_abstraction(
        ...
        from t4dm.core.provenance import sign_embedding
