...
async def get_services(session_id: str | None = None):
    ...
    from t4dm.core.validation import validate_session_id
    ...
    async with _get_init_lock():
        if session_id:
            if session_id in _service_instances:
                ...
                from t4dm.core.bridge_container import clear_bridge_containers
                from t4dm.core.bridge_container import _containers
