...
Usage:
    python -m t4dm.diagrams --input-dir docs/diagrams/ --format all --output-dir exports/
    python -m t4dm.diagrams --input-dir docs/diagrams/ --format json --output exports/graph.json
"""
...
from t4dm.diagrams.export import export_all, export_graph
