...
Integration:
    ```python
    from t4dm.encoding.adapter_training import AdapterTrainer, TrainingConfig
    from t4dm.encoding.online_adapter import OnlineEmbeddingAdapter
    from t4dm.learning.retrieval_feedback import RetrievalFeedbackCollector
...
if TYPE_CHECKING:
    from t4dm.embedding.adapter import EmbeddingAdapter
    from t4dm.learning.retrieval_feedback import RetrievalFeedbackCollector, RetrievalFeedback
