...
from t4dm.learning.eligibility import EligibilityTrace as EligibilityTraceSystem
...
def create_three_factor_rule(
    ...
    **kwargs
    ...
    """
    from t4dm.learning.neuromodulators import create_neuromodulator_orchestra
