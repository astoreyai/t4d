...
from t4dm.encoding.ff_encoder import FFEncoder, FFEncoderConfig, get_ff_encoder
...
class EpisodicMemory:
    ...
    def __init__(self, session_id: str | None = None):
        ...
        from t4dm.embedding.query_memory_separation import get_query_memory_separator
        ...
        from t4dm.memory.pattern_separation import PatternCompletion
    ...
    async def create(
        ...
        try:
            from t4dm.consolidation.service import get_consolidation_scheduler
    ...
    async def _store_promoted_item(self, item) -> Episode | None:
        ...
        """
        from t4dm.memory.buffer_manager import BufferedItem
