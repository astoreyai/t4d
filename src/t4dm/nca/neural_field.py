...
if TYPE_CHECKING:
    ...
    from t4dm.nca.adenosine import AdenosineDynamics
    from t4dm.nca.astrocyte import AstrocyteLayer
    from t4dm.nca.connectome import Connectome, ConnectomeIntegrator
    from t4dm.nca.delays import TransmissionDelaySystem
    from t4dm.nca.oscillators import FrequencyBandGenerator
    from t4dm.nca.striatal_coupling import DAACHCoupling
...
class NeuralFieldSolver:
    ...
    def _configure_from_connectome(self) -> None:
        ...
        from t4dm.nca.connectome import ConnectomeIntegrator
...
from t4dm.nca.coupling import LearnableCoupling  # noqa: E402

try:
    from t4dm.nca.attractors import StateTransitionManager  # noqa: E402
except ImportError:
