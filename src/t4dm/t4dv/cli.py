...
from t4dm.t4dv.bus import get_bus
...
def main(argv: list[str] | None = None) -> None:
    ...
    if args.backend == "mpl":
        from t4dm.t4dv.renderers.mpl import register_mpl_renderers
        register_mpl_renderers(registry)
    else:
        from t4dm.t4dv.renderers.plotly_renderer import register_plotly_renderers
