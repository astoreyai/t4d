...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        data_dir = Path(os.environ.get("WW_DATA_DIR", "/var/lib/world-weaver"))
    ...
    try:
        from ww.api.websocket import health_metrics_broadcaster
...
try:
    from ww.api.websocket import router as websocket_router
