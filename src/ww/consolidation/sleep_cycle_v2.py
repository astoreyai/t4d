...
from ww.consolidation.nrem_phase import NREMConfig, NREMPhase, NREMResult
from ww.consolidation.prune_phase import PruneConfig, PrunePhase, PruneResult
from ww.consolidation.rem_phase import REMConfig, REMPhase, REMResult
