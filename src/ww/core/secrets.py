...
Usage:
    from ww.core.secrets import get_secrets_manager, SecretKey
...
class SecretKey(Enum):
    ...
    DATABASE_PASSWORD = "WW_DATABASE_PASSWORD"
    DATABASE_URL = "WW_DATABASE_URL"
    NEO4J_PASSWORD = "WW_NEO4J_PASSWORD"
    QDRANT_API_KEY = "WW_QDRANT_API_KEY"
    ...
    # Authentication
    JWT_SECRET = "WW_JWT_SECRET"
    API_KEY_HASH_SECRET = "WW_API_KEY_HASH_SECRET"

    # Encryption
    ENCRYPTION_KEY = "WW_ENCRYPTION_KEY"

    # External services
    SENTRY_DSN = "WW_SENTRY_DSN"
...
class EnvironmentBackend(SecretBackend):
    ...
    def __init__(self, prefix: str = ""):
        ...
        Args:
            prefix: Optional prefix for all keys (e.g., "WW_")
        """
        self._prefix = prefix
...
class FileBackend(SecretBackend):
    ...
    e.g., WW_DATABASE_PASSWORD -> /secrets/ww_database_password
    """
...
class SecretsConfig:
    ...
    def from_env(cls) -> SecretsConfig:
        ...
        return cls(
            backend=os.environ.get("WW_SECRETS_BACKEND", "auto"),
            secrets_dir=os.environ.get("WW_SECRETS_DIR", "/run/secrets"),
            fallback_dir=os.environ.get("WW_SECRETS_FALLBACK_DIR"),
            env_prefix=os.environ.get("WW_SECRETS_ENV_PREFIX", ""),
            audit_access=os.environ.get("WW_SECRETS_AUDIT", "true").lower() == "true",
            cache_secrets=os.environ.get("WW_SECRETS_CACHE", "false").lower() == "true",
        )
